    ...
    view! {
        <div class="flex flex-col gap-4">
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 md:gap-4">
                ...
                <div class="bg-zinc-800 px-4 sm:px-8 py-4 rounded-md">
                    <dl class="m-0">
                        <dt class="text-sm text-zinc-400 font-medium">"Volume (24H)"</dt>
                        <div class="flex flex-row items-center gap-2">
                            <dd class="m-0 text-2xl font-semibold align-baseline proportional-nums">
                                "$0.00"
                            </dd>
                ...
                <div class="bg-zinc-800 px-4 sm:px-8 py-4 rounded-md">
                    <dl class="m-0">
                        <dt class="text-sm text-zinc-400 font-medium">"Fees (24H)"</dt>
                        <div class="flex flex-row items-center gap-2">
                            <dd class="m-0 text-2xl font-semibold align-baseline proportional-nums">
                                "$0.00"
                            </dd>
                ...
                <div class="bg-zinc-800 px-4 sm:px-8 py-4 rounded-md">
                    <dl class="m-0">
                        <dt class="text-sm text-zinc-400 font-medium">"APR (7D)"</dt>
                        <dd class="m-0 text-2xl font-semibold align-baseline proportional-nums">
                            "0.00%"
                        </dd>
                    </dl>
                ...
                <div class="bg-zinc-800 px-4 sm:px-8 py-4 rounded-md">
                    <dl class="m-0">
                        <dt class="text-sm text-zinc-400 font-medium">
                ...
                <div class="bg-zinc-800 px-4 sm:px-8 py-4 rounded-md">
                    <dl class="m-0">
                        <dt class="text-sm text-zinc-400 font-medium">"+2% Depth"</dt>
                        <dd class="m-0 text-2xl font-semibold align-baseline proportional-nums">
            ...
            <div class="p-4 sm:p-7 bg-zinc-800 rounded-md border border-solid border-zinc-700">
                <div class="grid grid-cols-[minmax(0px,_1fr)_80px_80px] sm:grid-cols-[minmax(0px,_3fr)_minmax(0px,_1fr)_minmax(0px,_1fr)]">
                    <div class="flex flex-col gap-4">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">"Pool"</p>
                            <div class="flex flex-row items-center gap-2">
                                ...
                                <div
                                    ...
                                    class="text-zinc-400 hover:brightness-75 active:brightness-125"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener"
                                    class="text-zinc-400 hover:brightness-75"
                                >
                        ...
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">"Bin steps"</p>
                            <p class="text-base font-semibold m-0">{bin_step()}"bps"</p>
                        </div>
                        // TODO: is the Version stored anywhere?
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">"Pool Version"</p>
                            <p class="text-base font-semibold m-0">v2.2</p>
                        </div>
                        // TODO: I'm not sure what this means.
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">"Pool Status"</p>
                            <p class="text-base font-semibold m-0">Main</p>
                        </div>
                    </div>
                    <div class="flex flex-col gap-4">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">"Base fee"</p>
                        ...
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">"Max fee"</p>
                            <p class="text-base font-semibold m-0">
                                <Suspense fallback=|| {
                                    view! { "Loading..." }
                        ...
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-zinc-400 font-semibold m-0">"Protocol fee"</p>
                            <p class="text-base font-semibold m-0">
                                <Suspense fallback=|| {
                                    view! { "Loading..." }
                                }>
            ...
            <div class="p-4 sm:p-8 bg-zinc-800 rounded-md border border-solid border-zinc-700">
                <div class="relative">
